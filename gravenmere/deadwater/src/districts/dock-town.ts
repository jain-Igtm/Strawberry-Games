...
import { addStAgnesHospital } from './st-agnes/st-agnes-hospital'
import {
  BAR_POSITION,
  DOCK_TOWN_ROADS,
  FALLOUT_HILLS,
...
function addHospitalComplex(
  ...
  // The replacement remains part of the complete Dock Town scene. Only the
  // hospital builder is delegated so this change can be cherry-picked without
  // dragging unrelated map edits into the main game.
  addStAgnesHospital({ context, materials })
