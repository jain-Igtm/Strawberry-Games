...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 16')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.16.0"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.16.0 (16) project.')
