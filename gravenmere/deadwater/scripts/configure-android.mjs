...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 19')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.18.0"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.18.0 (19) project.')
