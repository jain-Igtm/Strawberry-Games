...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 22')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.18.3"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.18.3 (22) project.')
