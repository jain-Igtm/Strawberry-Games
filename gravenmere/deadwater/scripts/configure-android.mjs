...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 34')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.19.4"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.19.4 (34) project.')
