...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 35')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.19.5"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.19.5 (35) project.')
