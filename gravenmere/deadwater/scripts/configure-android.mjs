...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 23')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.18.4"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.18.4 (23) project.')
