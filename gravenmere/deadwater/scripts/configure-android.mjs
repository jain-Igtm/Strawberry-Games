...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 15')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.15.0"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.15.0 (15) project.')
