...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 21')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.18.2"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.18.2 (21) project.')
