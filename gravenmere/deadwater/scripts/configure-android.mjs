...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 20')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.18.1"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen Ashfall Android 0.18.1 (20) project.')
