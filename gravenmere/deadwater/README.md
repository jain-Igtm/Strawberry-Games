...
St. Agnes is a primary combat space rather than a small facade. Its playable ground floor adapts the public-domain HABS survey of St. Elizabeths Hospital's West Wing into Oak Ward and Gray Ash corridors, patient rooms, a day room, treatment and pharmacy spaces, reception, emergency entrances, and several circulation loops. The source and adaptation notes are recorded in [`HOSPITAL_LAYOUT_SOURCE.md`](./HOSPITAL_LAYOUT_SOURCE.md). The water-tower face now clears the surrounding roofline in full, and the enlarged textured mushroom cloud rises high enough to require looking upward near the factory road.
