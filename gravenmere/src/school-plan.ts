...
const connections = [
  ...
  { a: 'south-cloister', b: 'founders-court', sideA: 'north', sideB: 'south', width: 18, vaulted: true },
  { a: 'north-cloister', b: 'founders-court', sideA: 'south', sideB: 'north', width: 18, vaulted: true },
  { a: 'west-cloister', b: 'founders-court', sideA: 'east', sideB: 'west', width: 16, vaulted: true },
  { a: 'east-cloister', b: 'founders-court', sideA: 'west', sideB: 'east', width: 16, vaulted: true },
