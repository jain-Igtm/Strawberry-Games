...
buildGradle = buildGradle.replace(/versionCode \d+/, 'versionCode 10')
buildGradle = buildGradle.replace(/versionName "[^"]+"/, 'versionName "0.5.1"')
writeFileSync(buildGradlePath, buildGradle)

console.log('Configured landscape, fullscreen World Explorer Android 0.5.1 (10) project.')
